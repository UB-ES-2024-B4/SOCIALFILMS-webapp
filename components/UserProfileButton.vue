...
<template>
	<div class="flex items-center justify-center gap-2 bg-neutral-400/40 p-2 rounded-full shadow-sm w-max">
    <img
    ...
    <div class="text-left">
      ...
      <p class="text-gray-300 text-xs">@arfimaulana_</p>
		...
		<Button icon="pi pi-chevron-down" variant="text" severity="secondary" rounded @click="toggle" :pt="{
