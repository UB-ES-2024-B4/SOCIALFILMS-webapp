...
BEGIN
    IF EXISTS (
        ...
        RAISE EXCEPTION 'El registro ya existe para user_id %, movie_id %, relation_type %',
                        target_user_id, _movie_id, _relation_type;
    END IF;
...
BEGIN
    IF NOT EXISTS (
        ...
        RAISE EXCEPTION 'El registro no existe para user_id %, movie_id %, relation_type %',
                        target_user_id, _movie_id, _relation_type;
    END IF;
