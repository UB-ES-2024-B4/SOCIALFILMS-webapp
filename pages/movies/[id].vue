...
<template>
  <div class="w-full min-h-screen">
    <!-- Backdrop Image -->
    <div
      class="relative w-full h-[28rem] bg-cover bg-center bg-fixed transition-opacity"
      :style="{ backgroundImage: `url(${film.backdrop})`, opacity: backdropOpacity }"
      >
    </div>
      ...
      <div class="flex flex-col">
        ...
        <div class="flex flex-col flex-1 mt-4 md:flex-row md:mt-0 gap-14">
          ...
          <div class="flex-1 flex flex-col space-y-3">
            <h2 class="text-lg text-gray-500 dark:text-gray-400">{{ formattedGenres }}</h2>
            ...
            <div class="flex items-center space-x-2 mt-4">
              ...
              <span class="tag bg-gray-100 text-gray-600 dark:bg-gray-500 dark:text-gray-100">
